 ...
 *
 * This file contains SVG icons from Feather Icons (https://feathericons.com)
 * Licensed under the MIT License
 *
 * Copyright (c) 2013-present Cole Bemis and Feather Icons contributors
 *
 * See ICONS-LICENSE.md for full license text and attributions
 */

/**
 * Icon SVG strings indexed by icon name (Feather Icons naming convention)
 * Each SVG has viewBox="0 0 24 24" for consistent scaling
 */
 ...
 * @param name Icon name (e.g., 'search', 'wifi', 'trash-2')
