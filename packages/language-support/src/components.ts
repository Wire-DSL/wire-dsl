...
export interface PropertyMetadata {
  name: string;
  type: 'string' | 'enum' | 'boolean' | 'number' | 'color' | 'action' | 'list';
  description?: string;
  defaultValue?: any;
  required?: boolean;
...
export const COMPONENTS: Record<string, ComponentMetadata> = {
  ...
  Topbar: {
    ...
    properties: {
      ...
      actions: { name: 'actions', type: 'list' },
  ...
  SidebarMenu: {
    ...
    properties: {
      id: idProp,
      visible: visibleProp,
      items: { name: 'items', type: 'list', required: true },
      icons: { name: 'icons', type: 'list' },
      active: { name: 'active', type: 'number' },
      variant: variantWithDefaultEnum,
      onItemsClick: { name: 'onItemsClick', type: 'list', description: 'Screen names aligned by index with items. e.g. ["HomeScreen", "UsersScreen", "SettingsScreen"]' },
    },
  ...
  Tabs: {
    ...
    properties: {
      ...
      icons: { name: 'icons', type: 'list', description: 'Icon names aligned to each tab.' },
  ...
  Table: {
    ...
    properties: {
      ...
      visible: visibleProp,
      title: { name: 'title', type: 'string' },
      columns: { name: 'columns', type: 'list', required: true },
      rows: { name: 'rows', type: 'number' },
      rowsMock: { name: 'rowsMock', type: 'number' },
      mock: { name: 'mock', type: 'list' },
