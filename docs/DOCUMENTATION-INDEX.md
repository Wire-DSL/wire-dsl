...
1. **[DSL Syntax Guide](DSL-SYNTAX)** - Learn the basic syntax and structure
...
See [DSL-SYNTAX - Complete Example](DSL-SYNTAX#complete-example)
...
```
docs/
├── DSL-SYNTAX           # Main syntax reference
...
1. **Read** [DSL-SYNTAX](DSL-SYNTAX) for language syntax
